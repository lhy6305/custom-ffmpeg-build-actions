...
# Developer options
CONFIGURE_OPTIONS="$CONFIGURE_OPTIONS --enable-static --disable-shared --disable-all --disable-autodetect --enable-ffmpeg --enable-ffplay --enable-sdl --disable-ffprobe --enable-protocol=file,udp --enable-indev=dshow --enable-avcodec --enable-avformat --enable-avdevice --enable-avformat --enable-avfilter --enable-avutil --enable-swresample --enable-swscale --disable-filters --enable-filter=aresample,atempo --disable-bzlib --disable-iconv --disable-lzma --enable-encoder=pcm_s16le --enable-decoder=opus,pcm_s16le --enable-demuxer=mpegts,wav --enable-parser=opus --disable-fast-unaligned --disable-debug --disable-stripping --enable-pthreads --disable-w32threads --disable-os2threads --disable-safe-bitstream-reader --disable-zlib --disable-d3d11va --disable-dxva2 --disable-mediafoundation --disable-schannel --disable-cuda_llvm --enable-small --disable-doc --disable-large-tests"
